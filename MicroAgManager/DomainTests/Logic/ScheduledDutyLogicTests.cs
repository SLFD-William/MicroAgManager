    ...
    {
        [TestClass()]
        public class ScheduledDutyLogicTests
        {
            [TestMethod()]
            public async Task GetNextChoreDueDateTest_ScheduledDutyNotChore()
            {
                ...
                // Act
                var result = await ScheduledDutyLogic.GetNextChoreDueDate(context as DbContext, scheduledDuty);
            ...
            public async Task OnScheduledDutyCompletedTest_CommandDoesNotRequireReschedule()
            {
                ...
                // Act
                var result = await ScheduledDutyLogic.OnCompleted(context as DbContext, command, duty);
            ...
            public async Task GetNextFreqAndDurationDueDateTest_ScheduledDutyIsChore()
            {
                ...
                // Act
                var result = await ScheduledDutyLogic.GetNextFreqAndDurationDueDate(context as DbContext, scheduledDuty);
