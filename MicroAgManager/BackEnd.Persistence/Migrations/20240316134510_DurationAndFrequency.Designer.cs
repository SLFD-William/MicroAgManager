...
namespace BackEnd.Persistence.Migrations
{
    ...
    [Migration("20240316134510_DurationAndFrequency")]
    partial class DurationAndFrequency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChoreDuty", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Chore", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("DurationScalar")
                        .HasPrecision(18, 3)
                    ...
                    b.Property<decimal>("EveryScalar")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<long?>("EveryUnitId")
                        .IsRequired()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("PerScalar")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<long?>("PerUnitId")
                        .IsRequired()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ChoreDuty", b =>
                {
                    b.HasOne("Domain.Entity.Chore", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.Chore", b =>
                {
                    b.HasOne("Domain.Entity.Unit", "EveryUnit")
                        .WithMany()
                        .HasForeignKey("EveryUnitId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entity.Unit", "PerUnit")
                        .WithMany()
                        .HasForeignKey("PerUnitId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("EveryUnit");
